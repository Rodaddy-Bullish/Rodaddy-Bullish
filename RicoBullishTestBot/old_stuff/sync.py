...
# APP_ID=26217270
# APP_HASH='ebcdc60becdd85cc61559cfa2a7d60b8'
# APP_TITLE='BullishTechOps'
# SHORT_NAME='BullishTechOps'
# SESSION_STRING='1AZWarzYBu79h_BkS0yaRMGEYev3C_YG8wqvJ_CMfIbaoHAGlDDt8cPCf0kAG9K-M84zdwHuk3qwz4-xFabu2U7Qg3O-IzJw-N6c7ZNtea01Nt-Ubo3055n7471-i9aRsIr85kIgvg-Rh-bq_HdBZzRbZtGGV9FYAozBJ-btXlYODs-3vBEDTR9HNlhc2ZM1JkOlgs3htKJZdaVIawd3tKRw-pwdbmFRO6LpH3pdB3OuurpCZUmJcS63MZD72YnjJ8F2K8k9sVi8-RhXeXXOHvdp4L8sd7AH51dqPe80pQfKPfZni1p5f7tXtxXcz4uJKs6iQgnrRelkqkcXKB8Y4RwIwD1_6CZs='
#
...
class Sync:
    ...
    def __init__(self, config, session_file, db, client=None):
        self.config = config
        self.db = db
    ...
    def sync(self, ids=None, from_id=None, group_id=None):
        """
        ...
        while True:
            has = False
            from tgClient import fetch_messages
            # messages = await fetch_messages(client=self.client, chat=group_id)
            ...
            # for m in messages:
                ...
                #     self.db.insert_user(m.user)
                    ...
                    self.db.insert_user(m.sender_id)
                else:
                    i = 1
    ...
    def new_client(self, session, config):
        api_id = 26217270
        api_hash = 'ebcdc60becdd85cc61559cfa2a7d60b8'
    ...
    def _fetch_messages(self, group, offset_id, ids=None) -> Message:
        try:
            if self.config.get("use_takeout", False):
                ...
                wait_time = None
            messages = self.client.get_messages(group,
                                                offset_id=offset_id,
    ...
    async def fetch_messages (self, chat, offset_id=0, limit=100):
        all_messages = []
        while True:
